# -*- coding: utf-8 -*-
"""190709P_layer_10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MWJIWlJskjEzCOUR0ZxKY3n9XkkOxTWi
"""
...
train_data = pd.read_csv('/kaggle/input/datavalue/train.csv').dropna()
valid_data = pd.read_csv('/kaggle/input/datavalue/valid.csv').dropna()
test_data = pd.read_csv('/kaggle/input/datavalue/test.csv')
...
x_train_trf = pd.DataFrame(x_train_pca)
x_valid_trf = pd.DataFrame(x_valid_pca)
x_test_trf = pd.DataFrame(x_test_pca)

best_model_label_1 = svm.SVC(C=10, gamma=1, kernel='poly',degree=3)
best_model_label_1.fit(x_train_trf,y_train[L1])
...
# **Hyperparameter Tuning - Random Grid Search**
randomizedSearch(svm.SVC(),x_train_pca,y_train[L1])
...
best_model_label_2 = svm.SVC(C=100,kernel='poly',gamma=1,degree= 4)
...
accuracy_svc = cross_val_score(svm.SVC(C=100, gamma=0.01,kernel = 'rbf',degree=4), x_train, y_train[L3], cv=3).mean()
print(accuracy_svc)

best_model_label_3 = svm.SVC(C=10, gamma=0.1, kernel='rbf',degree=3)
